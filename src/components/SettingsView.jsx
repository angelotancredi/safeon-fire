...
// import { motion } from 'framer-motion'; // Removed as motion.div was changed to plain div or unused
                    ...
                    <div className="bg-white border border-tactical-border rounded-3xl p-5 shadow-sm space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-end">
                                ...
                                <span className="text-[13px] font-black text-tactical-accent font-mono">{settings.squelchVol}%</span>
                            </div>
                            <input
                                type="range"
                                min="0"
                                max="100"
                                value={settings.squelchVol}
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-end">
                                ...
                                <span className="text-[13px] font-black text-tactical-accent font-mono">{settings.micSens}%</span>
                            </div>
                            <input
                                type="range"
                                min="0"
                                max="100"
                                value={settings.micSens}
                    ...
                    <div className="bg-tactical-surface border border-tactical-border rounded-3xl p-6 shadow-sm border-dashed">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-tactical-muted font-bold tracking-tight">BUILD 2026.02.11 / STABLE</p>
                            </div>
                        </div>
                        <div className="mt-6 flex flex-col space-y-2">
                            <div className="flex justify-between text-[9px] font-bold text-tactical-muted uppercase">
                                <span>Protocol</span>
                                <span>Pusher-VoIP/1.0</span>
                            </div>
                            <div className="flex justify-between text-[9px] font-bold text-tactical-muted uppercase">
                                <span>Encryption</span>
                                <span>AES-256-GCM (Browser-Native)</span>
                            </div>
                        </div>
                    </div>
                </div>
